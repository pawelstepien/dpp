        ...
        <section class="section-contact-icons">
            <div class="contact-icons-wrapper">
                <a href="tel:<?= get_field( 'phone' ) ?>" class="contact-anchor">
                    <img src="/build/media/contact-phone-icon.png?version=0.8" alt="Telefon" class="contact-icon">
                    <span class="contact-text">
                        <?= format_phone( get_field( 'phone' ) ) ?>
                    </span>
                </a>
                <a href="mailto:<?= get_field( 'email' ) ?>" class="contact-anchor">
                    <img src="/build/media/contact-mail-icon.png?version=0.8" alt="e-mail" class="contact-icon">
                    <span class="contact-text">
                        <?= get_field( 'email' ) ?>
                    </span>
                </a>
                <a href="<?= get_field( 'facebook' ) ?>" class="contact-anchor" target="_blank">
                    <img src="/build/media/contact-facebook-icon.png?version=0.8" alt="Facebook" class="contact-icon">
                    <span class="contact-text">
                        facebook
                    </span>
                </a>
                <a href="<?= get_field( 'messenger' ) ?>" class="contact-anchor" target="_blank">
                    <img src="/build/media/contact-messenger-icon.png?version=0.8" alt="Messenger" class="contact-icon">
                    <span class="contact-text">
                        messenger
                    </span>
                </a>
                <a href="//<?= get_field( 'page-url' ) ?>" class="contact-anchor" target="_blank">
                    <img src="/build/media/contact-site-icon.png?version=0.8" alt="Strona" class="contact-icon">
                    <span class="contact-text">
                        <?= get_field( 'page-url' ) ?>
                    </span>
                </a>
